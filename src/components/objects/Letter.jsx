...
const Container = styled.section`
	...
	left: 0;
	margin: auto;
	border-width: ${(props) => 63 * props.sizeMultiplier}px
		${(props) => 43 * props.sizeMultiplier}px;
	border-style: solid;
	border-color: #9e9abd;
	border-radius: 50%;
`
...
const Foreground = styled.div`
	...
	height: 0;
	border-width: ${(props) => 34 * props.sizeMultiplier}px
		${(props) => 35 * props.sizeMultiplier}px;
	border-style: solid;
	border-color: transparent #ecc460 #f7d98f;
	border-radius: 0 0 ${(props) => 10 * props.sizeMultiplier}px
		${(props) => 10 * props.sizeMultiplier}px;
	...
	&:before {
		...
		transition: border-bottom-width ease-in ${speed} ${speed},
			...
			top ease-in ${speed} ${speed}, z-index linear ${speed} ${speed};
	}
	...
	&:hover:after {
		...
		box-shadow: 0 ${(props) => 36 * props.sizeMultiplier}px 0
			${(props) => 7 * props.sizeMultiplier}px #d77e35;
